...
published: false
---
A high level design (often referred to as a blueprint) is a living document that evolves with the project through the [service design and delivery process](/standard/service-design-and-delivery-process/). At a minimum it describes the intent of the change or new product or service. It highlights the impacts on users’ experience, stakeholders, processes, technology, policy and law. It is about generating and refining ideas to design solutions that are integrated, holistic and balanced.
...
The high level design is developed by capturing outcomes throughout the [service design and delivery process](/standard/service-design-and-delivery-process). It provides the major input into project plans and the detailed design documents that ensure the service delivers on the intent.

A good high level design will ensure [the team](/standard/design-guides/the-team/) is aware of:
...
*   opportunities to use [common platforms](/standard/design-guides/government-as-a-platform/).

## High level design users

A high level design is usually put together by a single creator (or creator team) to maintain a cohesive voice, but is contributed to by [the team](/standard/design-guides/the-team/) working through the [service design and delivery ](/standard/service-design-and-delivery-process/).
...
*   Who are the users? [User research](/standard/design-guides/user-research/) will help to inform who your user groups; capturing this information in [personas](/standard/design-guides/user-research/personas/) and empathy maps can help to bring the data to life.
*   How will the users interact with the change? This may be captured through [user pathways](/standard/design-guides/user-research/user-pathways/), [scenarios](/standard/design-guides/user-research/scenarios/) and user journey maps.
*   What options are there?
*   What are the culture, process, products, workforce, policy, law and systems that need to be modified or developed? It’s good to map these against your [user pathway](/standard/design-guides/user-research/user-pathways/) or business process maps to ensure that each step has been considered.
*   How will the new products and services fit together and fit within the existing system? This can be explored in [user pathways](/standard/design-guides/user-research/user-pathways/) and business process maps or diagrams.
...
You can support the ongoing development of the high level design through the composition of [the team](/standard/design-guides/the-team/) and the choices of regular design activities.
